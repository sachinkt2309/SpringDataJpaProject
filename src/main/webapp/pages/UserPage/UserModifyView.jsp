...
<sql:setDataSource var="dbsource" driver="com.mysql.cj.jdbc.Driver"
        ...
        <sql:query dataSource="${dbsource}" var="result">
            SELECT * from User_setup1 where Delete_Status=0;
              </sql:query>
    <div class="mainpage">
        <nav class="navbar">
    <div id="Optionbar">
   ...
   <option><tr><th>Corporate_Id &nbsp</th><th>&nbsp UserId &nbsp</th><th>&nbsp password &nbsp</th><th>&nbsp Department &nbsp</th><th>&nbsp Address &nbsp</th><th>&nbsp Phone &nbsp</th><th>&nbsp Action</th></tr></option>
   ...
   <td><c:out value="${c1.Phone_Number}"/></td>
    <td><a style="color:Green;" href="modifyUsr?userid=<c:out value="${c1.User_ID}" />">Update</a></td>
   </tr></option>
   </c:forEach>
    </table>
   </c:forEach>
