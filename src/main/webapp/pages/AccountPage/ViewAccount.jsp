...
<div class="mainpage">
 ...
 <c:forEach var="c" items="${result1.rows}">
  ...
  <option><tr><th>CorporateId&nbsp</th><th>&nbsp AccNumber &nbsp</th><th>&nbsp AccName &nbsp</th><th>&nbsp Currancy &nbsp</th><th>&nbspBranch</th><th>&nbsp AvalBalance</th></tr></option>
   <c:forEach var="c1" items="${result2.rows}"> 
   <option><tr>
   <td><c:out value="${c1.Corporate_Id}"/></td>
   <td>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<c:out value="${c1.Account_Number}"/></td>
   <td>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<c:out value="${c1.Account_Name}"/></td>
   <td>&nbsp&nbsp&nbsp<c:out value="${c1.Currency}"/></td>
   <td>&nbsp&nbsp&nbsp<c:out value="${c1.Branch}"/></td>
   <td>&nbsp&nbsp&nbsp<c:out value="${c1.Av_balance}"/></td>
    </tr></option ><br>
   </c:forEach>
</table>
</select><br><br>
